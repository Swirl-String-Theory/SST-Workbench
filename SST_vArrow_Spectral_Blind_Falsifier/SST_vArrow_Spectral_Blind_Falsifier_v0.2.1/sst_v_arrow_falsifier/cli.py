...
from .campaigns import build_recursive_campaign
...
def main():
    ...
    p=sp.add_parser("scan"); p.add_argument("campaign",nargs="?",default="campaigns"); p.add_argument("outdir",nargs="?",default="outputs_scan"); p.add_argument("--include-demo",action="store_true")
    p=sp.add_parser("blind"); p.add_argument("campaign"); p.add_argument("outdir"); p.add_argument("--config",default="config/default.json"); p.add_argument("--recursive",action="store_true"); p.add_argument("--include-demo",action="store_true")
    ...
    if a.cmd=="scan":
        _,summary=build_recursive_campaign(a.campaign,Path(a.outdir)/"campaign_scan",include_demo=a.include_demo); print(json.dumps(summary,indent=2))
    elif a.cmd=="blind": print(json.dumps(run_blind(a.campaign,a.outdir,a.config,a.recursive,a.include_demo),indent=2))
