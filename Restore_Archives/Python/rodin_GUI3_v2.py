...
class RodinGUI3(tk.Tk):
    ...
    def _bind_autoupdate(self):
        watch = [
            ...
            self.var_I, self.var_bounds_m, self.var_auto_bounds, self.var_grid_res, self.var_poly_pts, self.var_soft_m,
    ...
    def update_plot(self):
        ...
        compute_key = (str(self.var_preset.get()), lens_key, round(I, 9), round(bounds, 9), res, round(soft, 12))
        ...
        if recompute:
            ...
            self._cache = dict(grid=grid, Bx=Bx, By=By, Bz=Bz, Bmag=Bmag, bounds=bounds)
        else:
        ...
        self.fig.suptitle(
            ...
            f"res={res} | cache={'MISS' if recompute else 'HIT'}",
            fontsize=10,
        )
