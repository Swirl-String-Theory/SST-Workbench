...
echo ============================================================
echo SC-II v0.1.0 K3.1 seed-provenance focus
...
python -m sst_modal_clock.cli analyze-sc2-stage-a "%OUT%" config\provenance_focus_3p1.json || exit /b 1
...
python -m sst_modal_clock.cli analyze-sc2-gauge "%OUT%" config\provenance_focus_3p1.json || exit /b 1
python -m sst_modal_clock.cli analyze-sc2-provenance "%OUT%" config\provenance_focus_3p1.json || exit /b 1
...
python -m sst_modal_clock.cli analyze-sc2-stage-b "%OUT%" config\provenance_focus_3p1.json || exit /b 1
