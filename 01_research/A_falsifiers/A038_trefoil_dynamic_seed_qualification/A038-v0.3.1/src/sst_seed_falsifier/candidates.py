...
def generate(dataset,out,cfg,config_path=None,repo=None):
    ...
    manifest['source_audit_commitment_sha256']=object_sha256(load_json(private/'source_generation_audit.json')); manifest['source_audit_commitment_hash_basis']='canonical_json_sorted_compact_ascii_v1'; dump_json(out/'public_manifest.json',manifest)
