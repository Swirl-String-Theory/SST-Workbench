...
cd /d "%~dp0"
echo ============================================================
echo SST Knot Geometry Library v0.1.2 - full validation
 echo ============================================================
if not exist .venv (
...
echo [4/6] Verifying native backend and running unit tests...
python -c "import sst_knotlib._sstknot_native as n; print('Native backend: OK; OpenMP =', bool(n.openmp_enabled))" || goto :fail
