...
def main():
    ap=argparse.ArgumentParser(description="SST local thread-texture blind falsifier")
    ...
    print(json.dumps({"out":str(out),"overall_structural_status":report["overall_structural_status"],"datasets":len(report["datasets"])},indent=2))
