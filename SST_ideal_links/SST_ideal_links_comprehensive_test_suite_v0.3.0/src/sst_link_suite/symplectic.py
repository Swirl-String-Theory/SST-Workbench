...
def linearized_hamiltonian_spectrum(
    ...
    return {
        ...
        "spectrally_stable": bool(not np.any(unstable)),
        "used_pseudoinverse": bool(not diagnostics["full_rank"]),
        "interpretation": (
            "Dimensionless linearized spectrum of the selected effective closure. Absolute quantum "
            "energies require an independently derived action scale and hbar normalization."
        ),
    }
