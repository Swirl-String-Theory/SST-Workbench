...
for %%N in (64 96 128) do (
  ...
  python -m sst_modal_clock.cli analyze-sc2-stage-a "outputs\resolution_N%%N" "config\resolution_N%%N.json" || exit /b 1
  ...
  python -m sst_modal_clock.cli analyze-sc2-gauge "outputs\resolution_N%%N" "config\resolution_N%%N.json" || exit /b 1
)
