...
def main()->int:
    ap=argparse.ArgumentParser(description="Open alpha only if archived v0.4 H14 permits it.")
    ...
    if not ready and not a.diagnostic_override:
        ...
        # numerical target therefore never enters this process when H14 is closed.
        r={"benchmark_phase":"BLOCKED_BY_BLIND_RPO_FLOQUET_GATES","alpha_value_opened":False,
           "blind_verdict":src.get("verdict"),"reason":"H14 is closed; benchmark module not imported."}
    else:
