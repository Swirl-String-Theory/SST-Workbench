...
from .analysis import load_cfg,predict_all,measure_all,evaluate,reveal,_json_safe
...
def main(argv=None):
    ...
    if a.cmd=='evaluate':
        r=evaluate(a.pred,a.measure,a.out); print(json.dumps(_json_safe(r),indent=2,allow_nan=False)); return 0 if r['status'] in ('PASS','INCONCLUSIVE') else 3
