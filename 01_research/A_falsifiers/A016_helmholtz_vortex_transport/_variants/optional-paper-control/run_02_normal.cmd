...
set "OUT=%ROOT%outputs_normal_%TS%"
"%PY%" run_campaign.py --knots-dir "%SST_KNOTS_DIR%" --config configs\normal_v0.1.0.json --out "%OUT%" --threads %SST_NATIVE_THREADS% --require-native
set RC=%ERRORLEVEL%
echo [H-SST] NORMAL output: %OUT%
exit /b %RC%
