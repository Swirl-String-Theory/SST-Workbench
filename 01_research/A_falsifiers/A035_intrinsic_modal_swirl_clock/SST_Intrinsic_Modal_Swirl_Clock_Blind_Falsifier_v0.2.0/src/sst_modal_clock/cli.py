...
from .workflow import run_prepare,run_branch,run_analyze_stage_a,run_analyze_stage_b,reveal
...
def main(argv=None):
    ...
    a=s.add_parser('run');a.add_argument('work');a.add_argument('config');a.add_argument('--branch',choices=['stage_a','material','fixed'],required=True);a.add_argument('--limit',type=int)
