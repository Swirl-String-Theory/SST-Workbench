...
def clear_scene():
    ...
    # Try using ops with override in a safe way
                ...
                for region in area.regions:
                    if region.type == 'WINDOW':
                        ...
                        try:
                            ...
                            print("Scene clear failed using override:", e)
...
def main():
    ...
    # Apply boolean cuts
    combined_cutter = combine_meshes(cutters, "CombinedGrooveCutter")
    boolean_diff(grooved, combined_cutter, name="CutGrooves")
    bpy.data.objects.remove(combined_cutter, do_unlink=True)

    # Remove individual cutters cleanly
    for c in cutters:
