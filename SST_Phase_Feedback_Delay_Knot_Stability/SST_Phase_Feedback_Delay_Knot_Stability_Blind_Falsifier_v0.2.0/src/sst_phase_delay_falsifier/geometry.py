...
def kabsch_align(reference,moving):
    """Center and optimally rotate moving onto reference; return aligned moving."""
    a=center(reference); b=center(moving); H=b.T@a; U,_,Vt=np.linalg.svd(H); R=U@Vt
