...
Important: this is scalar diagnostic data, **not** a full `xyz(s,t)` centerline trajectory and not a `(k, omega)` spectrum. Therefore v0.2.0 keeps it as `diagnostic_only`; it cannot by itself establish a propagation speed in m/s.
