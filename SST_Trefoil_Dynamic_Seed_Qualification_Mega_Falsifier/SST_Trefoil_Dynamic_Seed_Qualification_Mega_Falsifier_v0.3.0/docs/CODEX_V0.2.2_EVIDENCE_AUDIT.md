...
hard-coded that path and maintained separate source/topology declarations. v0.3.0 replaces
...
batch banners reported v0.2.1. v0.3.0 has one release identity (`RELEASE.json`, Python
