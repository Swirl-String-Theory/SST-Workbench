...
echo [SST] Verifying host/OpenMP extension under oneAPI environment without DLL-tree injection...
".venv\Scripts\python.exe" -X faulthandler -c "import native_ext._native as n; d=dict(n.backend_info()); print('[SST] HOST_NATIVE_OK', d); assert not bool(getattr(n,'sycl_compiled',False))" || exit /b 1
echo [WARN] Arc without native FP64: this EXTRA_EXTENDED SYCL campaign is FP32 SCREENING ONLY.
