...
def main() -> int:
    p = argparse.ArgumentParser(description="Run the SST Fermat standalone v0.6.0 certification audit battery.")
    ...
    summary = {
        "schema": "sst.fermat.audit.v0.6.0",
        "package_version": PACKAGE_VERSION,
        "audit_name": "SST Fermat v0.6.0 metadata and clock-domain certification audit",
        ...
        "ok": ok,
        "epistemic_guard": (
            "v0.6.0 resolves radial stationary candidates and certifies only convergence-qualified branches; "
