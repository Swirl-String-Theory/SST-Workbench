...
pre={'package_version':'0.1.0','config':cfg,'config_sha256':hashlib.sha256(config_text.encode()).hexdigest(),'public_manifest_commitment':pub['private_commitment_sha256'],'rule':'thresholds frozen before scoring; source names hidden until reveal'}
