...
def make_knot_record(path, *, expected_topology: str|None=None, core_radius: float|None=None,
    ...
    if len(canonical)==1 and expected:
        ...
        cert={'status':'UNVERIFIED','pass':False,'expected_topology':expected,'provider':'none','notes':['multi-component imported-geometry certification is not implemented in v0.2.2']}
    else:
