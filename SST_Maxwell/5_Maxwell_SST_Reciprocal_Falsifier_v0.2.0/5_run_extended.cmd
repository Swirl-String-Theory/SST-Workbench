...
set "OUT=%CD%\outputs_extended_%TS%"
mkdir "%OUT%" >nul 2>nul
echo ============================================================
echo 5_Maxwell v0.2.0 EXTENDED - ALL shared-final geometries
echo Native threads: %THREADS%
echo knots: "%KNOTS%"
echo out:   "%OUT%"
echo ============================================================
"%M5_PY%" tools\5_make_manifest.py --input-dir "%KNOTS%" --preset extended --config config\presets\extended.json --out "%OUT%\datasets.private.json" || exit /b 3
...
echo.
echo [5_Maxwell] EXTENDED COMPLETE: "%OUT%"
exit /b 0
