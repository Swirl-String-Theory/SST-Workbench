...
```bash
git apply --check vortexring-lab-v7.4-to-v7.4.1.diff
git apply vortexring-lab-v7.4-to-v7.4.1.diff
```

De patch laat de bestaande v7.4-bestanden intact en voegt de volgende v7.4.1-bestanden toe:

- `vortexring-lab-v7.4.1.html`;
- `validate-v7.4.1.py`;
- `release-notes-v7.4.1.md`;
- `stappenplan-vortexring-lab-v7x-v5.md`;
- dit instructiebestand.

## Verplichte controles

```bash
python validate-v7.4.1.py vortexring-lab-v7.4.1.html
```
...
```text
vortexring-lab-v7.4.1.html?selftest=1
```
