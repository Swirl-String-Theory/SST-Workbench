...
def main() -> None:
    ...
    ap.add_argument("html", nargs="?", default="../v7/vortexring-lab-v7.3.1.html")
    args = ap.parse_args()
    ...
    required = {
        'meta version': '<meta name="vortexlab-version" content="7.3.1">',
        'runtime version': "const APP_VERSION='7.3.1';",
        'base version': "const APP_BASE_VERSION='7.3';",
    ...
    forbidden = {
        ...
        'oude runtime version': "const APP_VERSION='7.3';",
        'BEL byte': '\x07',
        'replacement char': '\ufffd',
    }
