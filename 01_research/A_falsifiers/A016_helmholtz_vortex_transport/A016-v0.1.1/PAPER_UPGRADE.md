...
Family: **A016 — Helmholtz Vortex Transport**
Base: `v0.1.1`
...
## Optional control
Audit transport invariants under mirror and rigid-body transforms using the correct polar/axial transformation rule. Treat violations as numerical/definition failures, not new SST signals.
