...
def main():
    ...
    ap.add_argument('--backend',choices=['auto','openmp','cpu','sycl','sycl-fp32','sycl-dd32','sycl-fp64','python'],default='auto');ap.add_argument('--allow-sycl-cpu',action='store_true');ap.add_argument('--force-build',action='store_true');ap.add_argument('--build-verbose',action='store_true')
