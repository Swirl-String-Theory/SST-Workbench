...
\coordinate (P1)  at (0, 2.2);            
        \coordinate (P2)  at (0.705, -0.971);     
        \coordinate (P3)  at (-2.092, 0.680);     
        \coordinate (P4)  at (1.141, 0.371);      
        \coordinate (P5)  at (-1.293, -1.779);    
        \coordinate (P6)  at (0, 1.200);          
        \coordinate (P7)  at (1.293, -1.779);     
        \coordinate (P8)  at (-1.141, 0.371);     
        \coordinate (P9)  at (2.092, 0.680);      
        \coordinate (P10) at (-0.705, -0.971);    
        \coordinate (P11) at (0, 2.2);            

        \def(0,0) circle (2cm){
            ([closed] P1)..(P2)..(P3)..(P4)..(P5)..(P6)..(P7)..(P8)..(P9)..(P10)..(P11)
        }

        \RenderStrand{(0,0) circle (2cm)}{18}{0.15}
