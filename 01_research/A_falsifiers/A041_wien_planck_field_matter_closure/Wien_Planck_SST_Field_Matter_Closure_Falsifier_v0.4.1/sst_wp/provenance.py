...
def audit():
    ...
    return {
        ...
        "action_path_rule":
            "v0.4.1 pre-reveal campaign/scoring uses only L_hat=1, "
...
def main(out="Wien_Planck_SST_Field_Matter_Closure_Falsifier_v0.4.1-outputs/provenance_audit.json"):
    r = audit()
    dump_json(out, r)
...
if __name__ == "__main__":
    raise SystemExit(
        main(sys.argv[1] if len(sys.argv) > 1 else "Wien_Planck_SST_Field_Matter_Closure_Falsifier_v0.4.1-outputs/provenance_audit.json")
    )
