...
def main():
    ap=argparse.ArgumentParser(description='SST v0.4.5.3 full archive campaign: every Fremlin .fseries and every KnotPlot/RidgeRunner *_final.txt')
    ...
    ap.add_argument('--backend',default='auto',choices=['auto','openmp','cpu','sycl','python'])
