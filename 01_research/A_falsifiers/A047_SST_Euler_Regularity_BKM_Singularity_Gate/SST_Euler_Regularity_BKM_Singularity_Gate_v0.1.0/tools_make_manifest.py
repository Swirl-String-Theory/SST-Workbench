...
exclude={".venv","build","__pycache__",".pytest_cache","SST_Euler_Regularity_BKM_Singularity_Gate_v0.1.0-outputs"}
rows=[]
...
obj={"format":"SST-BKM-PACKAGE-MANIFEST-1","package":ROOT.name,"version":"0.1.0","files":rows}
