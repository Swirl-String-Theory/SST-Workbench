...
- Expanded `R_b/R_hole` to `[0.06125, 8]` and `Gamma_h/Gamma_0` to `[-8, 8]`.
- Replaced relative-residual ranking with absolute post-rigid-fit residual reduction.
- Added 2730-point default parameter grid, zero controls, convergence, axis robustness, mode projection, cache reuse, integrated manifest, and resume support.

## v0.6.1 — Global Fermat Geodesic Shooting and Monodromy
