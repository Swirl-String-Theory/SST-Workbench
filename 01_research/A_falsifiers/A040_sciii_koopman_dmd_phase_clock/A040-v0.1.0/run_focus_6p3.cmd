...
python -m sst_modal_clock.cli analyze-sciii-stage-a "%OUT%" config\focus_6p3.json || exit /b 1
...
python -m sst_modal_clock.cli analyze-sciii-gauge "%OUT%" config\focus_6p3.json || exit /b 1
...
python -m sst_modal_clock.cli analyze-sciii-stage-b "%OUT%" config\focus_6p3.json || exit /b 1
