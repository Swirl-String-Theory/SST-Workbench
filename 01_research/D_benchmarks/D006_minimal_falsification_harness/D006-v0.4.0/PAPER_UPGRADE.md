...
Family: **D006 — Minimal Falsification Harness**
Base: `v0.3.0`
Target: `v0.4.0`
Priority: `shared`
Paper inspiration: arXiv:2505.06829 + 1806.08362 — upstream certificates and downstream qualification.

## Shared numerical certification
Provide synthetic central-difference, rotation, covariance, Jacobian/Hessian and convergence checks. This benchmark may certify numerical machinery but never promote an SST hypothesis.
