...
import json
from sst_knotlib import classic_trefoil, shader_track_trefoil, torus_knot, figure8_s3, thread_bundle, qualify_seed
...
for name,p in seeds.items():
    ...
    # dimensionless demo core radius; physical falsifiers should normalize then inject their configured core radius
...
(out/'qualification_demo.json').write_text(json.dumps(report,indent=2),encoding='utf-8')
print(out)
