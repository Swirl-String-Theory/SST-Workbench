...
python -m sst_modal_clock.cli analyze-sc2-stage-a "%OUT%" config\focus_6p3.json || exit /b 1
...
python -m sst_modal_clock.cli analyze-sc2-gauge "%OUT%" config\focus_6p3.json || exit /b 1
...
python -m sst_modal_clock.cli analyze-sc2-stage-b "%OUT%" config\focus_6p3.json || exit /b 1
