# Validation — SST Knot Library v0.2.5
...
Result: PASS; `library_version = 0.2.5`.
...
## User v0.2.3 output audit motivating v0.2.5
...
## v0.2.5 local validation
- Python trust/format smoke tests: 27/27 PASS.
- Reference validation: PASS; library_version 0.2.5.
- Standalone C++17/OpenMP self-test: PASS.
- New regression: Fremlin `.short` source is distinct from KnotPlot fseries provenance.
- No geometry/topology/blind numerical kernels changed from v0.2.4.
