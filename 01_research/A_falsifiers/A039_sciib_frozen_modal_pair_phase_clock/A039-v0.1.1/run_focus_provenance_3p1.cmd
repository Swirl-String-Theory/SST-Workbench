...
echo ============================================================
echo SC-IIb v0.1.0 K3.1 seed-provenance focus
...
python -m sst_modal_clock.cli analyze-sciib-stage-a "%OUT%" config\provenance_focus_3p1.json || exit /b 1
...
python -m sst_modal_clock.cli analyze-sciib-gauge "%OUT%" config\provenance_focus_3p1.json || exit /b 1
python -m sst_modal_clock.cli analyze-sciib-provenance "%OUT%" config\provenance_focus_3p1.json || exit /b 1
...
python -m sst_modal_clock.cli analyze-sciib-stage-b "%OUT%" config\provenance_focus_3p1.json || exit /b 1
echo Result: %OUT%\analysis\blind_sciib_provenance_summary.json
