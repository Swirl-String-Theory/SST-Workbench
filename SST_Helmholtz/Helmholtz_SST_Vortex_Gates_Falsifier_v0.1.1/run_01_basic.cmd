...
"%PY%" run_campaign.py --knots-dir "%SST_KNOTS_DIR%" --config configs\basic_v0.1.0.json --out "%OUT%" --threads %SST_NATIVE_THREADS% --require-native
set RC=%ERRORLEVEL%
echo [H-SST] BASIC output: %OUT%
exit /b %RC%
