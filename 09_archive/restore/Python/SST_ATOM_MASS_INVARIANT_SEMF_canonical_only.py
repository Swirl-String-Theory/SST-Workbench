...
def get_particle_topologies(cfg: Config, phi_val: float = phi0) -> Dict:
    ...
    # Canonical-lepton policy: calibrate ONLY on the electron and predict higher generations
    # using the same geometric scale L_tot (no mu/tau back-solving).
    l_tot_mu = l_tot_e
    l_tot_tau= l_tot_e
...
if __name__ == "__main__":
    # Canonical-only execution: no parameter sweeps, no alternate modes.
    main()
