# SST Intrinsic Modal Swirl-Clock Blind Falsifier v0.2.2.7
> **v0.2.2.7 hotfix:** fixes Windows forwarding of comma-separated `--libraries=...` in `run_focus_topology.cmd`, creates `outputs\` before redirection, and corrects package metadata. Physics and numerical gates are unchanged.
