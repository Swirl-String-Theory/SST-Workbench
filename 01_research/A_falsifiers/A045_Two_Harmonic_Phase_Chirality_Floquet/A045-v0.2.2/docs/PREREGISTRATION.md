# Preregistration — v0.2.2

The v0.2.2 execution patch does not alter the preregistered scientific protocol, blind salts, gates, thresholds, seeds, or condition grid from v0.2.0.
