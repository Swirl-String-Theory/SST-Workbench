...
def integrate_ray(
    ...
    *,
    ...
    try:
        ...
        return {
            "schema": "sst.fermat.ray-integration.v0.5.1",
...
def shoot_closed_orbit(
    ...
    *,
    ...
    if best is None:
        return {
            "schema": "sst.fermat.closed-orbit-shot.v0.5.1",
            "package_version": PACKAGE_VERSION,
...
def certify_closed_orbit_convergence(
    ...
    *,
    ...
    return {
        "schema": "sst.fermat.closed-orbit-integration-convergence.v0.5.1",
        "package_version": PACKAGE_VERSION,
...
def certify_global_closed_orbit(
    ...
    *,
    ...
    return {
        "schema": "sst.fermat.global-closed-orbit-convergence.v0.5.1",
        "package_version": PACKAGE_VERSION,
        "knot_id": knot_id,
        "epsilon_over_rc": epsilon,
...
def compute_reduced_monodromy(
    ...
    *,
    ...
    if not bool(orbit_shot.get("global_closed_orbit_certified")) and not allow_uncertified_diagnostic:
        return {
            "schema": "sst.fermat.reduced-monodromy.v0.5.1",
            "package_version": PACKAGE_VERSION,
...
def certify_monodromy_convergence(
    ...
    *,
    ...
    return {
        "schema": "sst.fermat.monodromy-convergence.v0.5.1",
        "package_version": PACKAGE_VERSION,
