...
def run_case(path, cfg, resolution, eps_list):
    ...
    if gamma_hat != 1.0:
        raise RuntimeError("v0.4.0 strict blind action campaign requires gamma_dimensionless = 1")
...
def main():
    ...
    out = Path(a.out or f"Wien_Planck_SST_Field_Matter_Closure_Falsifier_v0.4.0-outputs/basic_{nowstamp()}")
