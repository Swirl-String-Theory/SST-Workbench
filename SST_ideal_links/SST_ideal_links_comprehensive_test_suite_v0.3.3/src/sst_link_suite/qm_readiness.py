...
def analyze_qm_readiness(link, cfg: dict, backend_options: BackendOptions, backend_metadata: dict) -> dict:
    ...
    return {
        ...
        "interpretation_boundary": (
            "This ledger tests QM-readiness of a reduced classical link model. v0.3.3 uses fixed physical "
            "self-exclusion arcs and D-dimensionalized energy terms, but a separate N-continuum audit is still "
