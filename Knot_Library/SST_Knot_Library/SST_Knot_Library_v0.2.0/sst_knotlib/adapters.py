...
def prepare_for_falsifier(points: np.ndarray, *, core_radius: float, n: int = 512,
                           ...
                           provider_id: str|None=None, provider_name: str|None=None,
    ...
    as certified merely because of a filename or caller label. Prefer provider_id from SOURCE.json
    over source_family path heuristics.
    """
