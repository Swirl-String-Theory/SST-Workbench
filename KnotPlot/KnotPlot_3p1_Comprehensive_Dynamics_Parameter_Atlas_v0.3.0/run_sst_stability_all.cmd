...
echo ============================================================
echo KnotPlot Atlas v0.3.4 -> SST v0.4.8 FULL STABILITY CHAIN
echo ============================================================
...
call run_82_sst_v048_spectral_dd32.cmd
if errorlevel 1 exit /b %ERRORLEVEL%

call run_83_sst_v048_confirm_fp64.cmd
if errorlevel 1 exit /b %ERRORLEVEL%

call run_84_sst_v048_synthesize.cmd
if errorlevel 1 exit /b %ERRORLEVEL%
...
echo ============================================================
echo DONE
echo Final stability matrix:
echo   analysis\SST_V048_STABILITY_MATRIX.md
echo ============================================================
exit /b 0
