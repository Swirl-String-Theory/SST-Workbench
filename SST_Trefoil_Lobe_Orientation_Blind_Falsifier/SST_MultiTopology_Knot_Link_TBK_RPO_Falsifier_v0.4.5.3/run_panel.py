...
def main():
    ap=argparse.ArgumentParser(description='SST v0.4.5.3 blind multi-topology knot/link TBK + RPO comparative panel')
    ap.add_argument('--config',default='configs/panel_basic.json');ap.add_argument('--out-dir',default='outputs_panel_basic');ap.add_argument('--backend',choices=['auto','openmp','cpu','sycl','python'],default='auto');ap.add_argument('--allow-sycl-cpu',action='store_true');ap.add_argument('--force-build',action='store_true');ap.add_argument('--build-verbose',action='store_true')
