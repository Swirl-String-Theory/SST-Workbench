...
def audit_link_continuum(link, cfg: dict, backend_options: BackendOptions) -> dict:
    ...
    for n in hydro_ns:
        ...
        repulsion=tube_repulsion_energy(curves,diameter,rep_soft,rep_margin,backend_options=backend_options)
    ...
    return {
        ...
        "status":(
            "[NUMERICAL] v0.3.5 retains the v0.3.4 split and separates analytic-Fourier derivative-sensitive geometry from O(N^2) "
