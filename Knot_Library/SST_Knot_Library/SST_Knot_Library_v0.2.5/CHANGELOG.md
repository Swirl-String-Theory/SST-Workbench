...
## v0.2.5
- Distinguish `Fremlin_FourierSeries` from KnotPlot `fseries` provenance.
- Add `.short` coordinate discovery with content sniffing.
- Add a fail-closed `fremlin_local_fourier` source-catalog provider; upstream authorship is explicitly not asserted.
- No geometry/topology/blind kernels changed.


## v0.2.5 — Ridgerunner VECT parser + auxiliary-file trust hotfix (2026-08-30)
