# SST Ideal Links Comprehensive Test Suite v0.3.2
...
## v0.3.2 Windows native preflight
...
## v0.3.2 scientific corrections

`L6a4` is catalogued as the **Borromean rings**. Its pairwise linking matrix is zero, so the v0.3.2 ledger marks a Milnor triple-linking computation as required; the value is not numerically inferred by this release.
