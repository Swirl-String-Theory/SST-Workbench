...
def write_csv(
    ...
    m = geom["m"]
    with open(outdir / "hodge_geometry_summary.csv", "w", newline="") as f:
        w = csv.writer(f)
    ...
    # --- bs_scan.csv ---
    with open(outdir / "hodge_bs_scan.csv", "w", newline="") as f:
        w = csv.writer(f)
    ...
    with open(outdir / "hodge_AK_summary.csv", "w", newline="") as f:
        w = csv.writer(f)
        w.writerow(["quantity", "value", "label", "note"])
    ...
    with open(outdir / "hodge_eigenvalue_summary.csv", "w", newline="") as f:
        w = csv.writer(f)
    ...
    with open(outdir / "hodge_derived_numbers.csv", "w", newline="") as f:
        w = csv.writer(f)
    ...
    # --- hodge_verdict.md ---
    with open(outdir / "hodge_verdict.md", "w") as f:
