...
_WORKER_BUILD_FLAGS='-fsycl|-fsycl-device-code-split=per_kernel|-O3|-std=c++17|protocol-v1'
...
def build_worker(force=False,verbose=True):
    ...
    cmd=[cxx,'-fsycl','-fsycl-device-code-split=per_kernel','-O3','-std=c++17',str(CPP),'-o',str(tmp)]
