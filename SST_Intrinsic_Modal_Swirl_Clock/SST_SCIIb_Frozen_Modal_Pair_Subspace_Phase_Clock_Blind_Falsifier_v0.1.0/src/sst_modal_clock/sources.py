...
def discover_katlas(root: Path,n_points: int) -> tuple[list[SourceGeometry],dict]:
    ...
    """
    root=Path(root); out=[]; stat={'records_total':0,'knot_records':0,'link_records':0,'braid_records':0,'pd_link_records':0,'geometry_records':0,'knot_geometry_records':0,'link_geometry_records':0,'metadata_only_no_supported_geometry':0,'metadata_only_no_braid':0,'parse_errors':0,'component_mismatch':0}
