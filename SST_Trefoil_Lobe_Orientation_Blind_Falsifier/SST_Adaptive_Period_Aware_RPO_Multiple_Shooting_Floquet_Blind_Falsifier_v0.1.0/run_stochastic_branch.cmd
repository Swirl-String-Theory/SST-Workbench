...
"%SST_V048_DIR%\.venv\Scripts\python.exe" rpo_falsifier.py --config configs\stochastic.json --out-dir outputs\stochastic --target "%SST_V048_DIR%" --atlas "%SST_ATLAS_ROOT%"
exit /b %ERRORLEVEL%
