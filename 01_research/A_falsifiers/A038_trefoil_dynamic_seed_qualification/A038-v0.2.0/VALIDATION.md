...
- Pytest methodology/regression suite: **14/14 PASS** before final packaging.
...
- v0.2.0 does not claim that the R557 regression geometry is the final physical trefoil champion.
