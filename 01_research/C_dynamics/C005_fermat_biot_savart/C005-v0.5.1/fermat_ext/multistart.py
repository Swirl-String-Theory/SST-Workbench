...
def multistart_closed_orbit_search(
    ...
    *,
    ...
    return {
        "schema": "sst.fermat.multistart-closed-orbit-search.v0.5.1",
...
def selected_seed_convergence(
    ...
    *,
    ...
    return {
        "schema":"sst.fermat.selected-seed-global-convergence.v0.5.1",
        "package_version":PACKAGE_VERSION,
...
def continue_selected_seed_in_epsilon(
    ...
    *,
    ...
    return {"schema":"sst.fermat.epsilon-continuation.v0.5.1","package_version":PACKAGE_VERSION,"knot_id":knot_id,"identity":identity,"levels":levels,"any_resolved":any(v.get("shot",{}).get("resolved_closed_orbit") for v in levels),"global_closed_orbit_certified":False,"qsm_certified":False}
