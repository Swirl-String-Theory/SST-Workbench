...
echo ============================================================
echo D006 Minimal Falsification Harness v0.4.1
echo Cheap path: paper-upgrade selftest + PC01 regressions + synthetic demo + audit
echo ============================================================
python "%PU_WB%\07_scripts\paper_upgrade_runtime.py" stage --family "%PU_FAMILY%" --tier "%PU_TIER%" --out "%PU_OUT%" --id "pc01_regressions" %PU_RESUME_FLAG% -- python pc01_regressions.py || exit /b 1
