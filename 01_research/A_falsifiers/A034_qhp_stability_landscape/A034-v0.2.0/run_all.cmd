...
python "%PU_WB%\07_scripts\paper_upgrade_runtime.py" stage --family "%PU_FAMILY%" --tier "%PU_TIER%" --out "%PU_OUT%" --id "paper_upgrade_cert" %PU_RESUME_FLAG% -- python "%PU_WB%\07_scripts\paper_upgrade_certs.py" emit-a034-synthetic --out "%PU_OUT%" --gate "paper_upgrade\gate.py" || exit /b 1
