...
from .workflow import run_prepare,run_branch,run_analyze,reveal
...
def main(argv=None):
 ...
 a=s.add_parser('run');a.add_argument('work');a.add_argument('config');a.add_argument('--branch',choices=['material','fixed'],required=True);a.add_argument('--limit',type=int)
 a=s.add_parser('analyze');a.add_argument('work');a.add_argument('config')
 ...
 elif ns.cmd=='analyze':o=run_analyze(ns.work,ns.config)
