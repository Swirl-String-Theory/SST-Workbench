...
## v0.2.0 geometry separation

`run_knot_campaign.py` does not synthesize these three canonical NPZ files from static centerlines. A real DFC campaign must export them from the dynamical SST solver with the declared independence metadata.
