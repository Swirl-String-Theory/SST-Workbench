...
1. [RESTRUCTURE_EPIC.md](RESTRUCTURE_EPIC.md) — the model, the invariants, why the phases are
...
3. [RESTRUCTURE_PLAN_v0.1.md](RESTRUCTURE_PLAN_v0.1.md) — the one-time mapping: all 73 current
...
|----|-------|----------|------|
| [SP00](SP00_freeze_and_provenance.md) | Freeze and provenance | P0 | low |
| [SP01](SP01_path_resolver.md) | Central path resolver | P0 | low |
| [SP02](SP02_compat_junction_layer.md) | Compatibility junction layer, stage 1 | P0 | low |
| [SP03](SP03_catalog_skeleton_and_hygiene.md) | Catalog skeleton and repo hygiene | P1 | low |
| [SP04](SP04_low_risk_moves.md) | Low-risk moves | P1 | low |
| [SP05](SP05_clean_family_moves.md) | Clean family moves | P1 | medium |
| [SP06](SP06_container_splits.md) | Ambiguous container splits | P2 | medium |
| [SP07](SP07_knotplot_refactor.md) | KnotPlot tool/data/campaign/result split | P2 | high |
| [SP08](SP08_catalog_metadata_and_registry.md) | Catalog metadata and registry | P3 | medium |
| [SP09](SP09_version_rename_stage2.md) | Version-directory rename, stage 2 | P3 | medium |
| [SP10](SP10_reproducibility_gate.md) | Reproducibility gate | P3 | medium |
| [SP11](SP11_decommission.md) | Decommission | P4 | high |
