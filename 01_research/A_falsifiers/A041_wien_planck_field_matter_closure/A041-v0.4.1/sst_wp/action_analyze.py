...
def main():
    ...
    if campaign is not None:
        ...
        pf = campaign.get("pklsa_funnel_preflight", {})
        funnel_preflight_pass = bool(pf.get("pass", True))
    else:
        expected_n = len(rows)
        campaign_reports_complete = True
        funnel_preflight_pass = True
    ...
    gates = {
        ...
        "UA0c_PKLSA_funnel_preflight": funnel_preflight_pass,
    ...
    recurrence_prereq = (
        ...
        and gates["UA0c_PKLSA_funnel_preflight"]
    ...
    out = {
        "format": "SST-WP-BLIND-ACTION-4.0",
