...
#ifdef SST_HAVE_SYCL
 auto& gq=qstate();d["sycl_compiled"]=true;if(gq.q){d["device_name"]=gq.name;d["is_gpu"]=gq.gpu;}else{d["device_name"]="not-initialized";d["is_gpu"]=false;}
#else
