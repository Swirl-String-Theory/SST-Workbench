...
class App(tk.Tk):
    def __init__(self):
        ...
        self.var_gen_outdir = tk.StringVar(value=os.path.join(os.getcwd(), "Knots_FourierSeries"))
        ...
        self.var_h_export_csv = tk.StringVar(value=os.path.join(os.getcwd(), "SST_helicity_gui.csv"))
    ...
    def _build_generate_tab(self, parent):
        ...
        ttk.Button(btns, text="Run generator", command=self.on_generate).pack(side="left")
