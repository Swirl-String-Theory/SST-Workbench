...
TIERS = {
    "quick": {
        "step01": ["--n", "24"],
        "step02": ["--resolutions", "24", "48", "64", "--integer-tolerance", "0.05", "--gauge-tolerance", "0.04"],
        "step03": ["--n-grid", "32"],
        "step06": ["--samples", "500"],
        "step07": ["--samples", "501"],
...
def main() -> int:
    ...
    commands = [
        ...
        ("step04", [sys.executable, "04_hopf_lading_numeriek.py", str(s02 / "analytic_hopf_benchmark.npz"), "--output", str(s04), "--director-order", "4"]),
        ...
        ("step08", [
            sys.executable, "08_trefoil_integratie.py",
            "--output", str(s08),
            "--hopf-evidence", str(s04 / "H1_H3_evidence.json"),
            "--helicity-evidence", str(s05 / "H5_evidence.json"),
            "--spin-evidence", str(s06 / "H6_H8_evidence.json"),
            "--spin-evidence", str(s07 / "H9_evidence.json"),
            *cfg["step08"],
        ]),
    ]
