...
call run_10_inventory_deep.cmd "%~1" || exit /b 1
set TOPO=%~3
if "%TOPO%"=="" set TOPO=3_1
call .venv\Scripts\activate.bat
python -m sst_pklsa --workbench "%~1" qualify --base "%~2" --topology "%TOPO%" --config configs\qualification_publication.json --out SST_Parametric_Knot_Link_Seed_Atlas_v0.3.0-outputs\qualification\%TOPO% || exit /b 1
