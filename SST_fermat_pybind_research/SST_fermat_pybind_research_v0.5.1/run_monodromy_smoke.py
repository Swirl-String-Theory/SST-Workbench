...
def main() -> int:
    ...
    result={'schema':'sst.fermat.monodromy-smoke.v0.5.1','shot':shot,'monodromy':monodromy,'pipeline_ok':True,'global_closed_orbit_certified':False,'monodromy_certified':False,'qsm_certified':False}
