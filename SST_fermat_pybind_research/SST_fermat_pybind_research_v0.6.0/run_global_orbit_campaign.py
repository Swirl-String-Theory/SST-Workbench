...
def main() -> int:
    p = argparse.ArgumentParser(description="Run the v0.6.0 global Fermat shooting and monodromy campaign.")
    p.add_argument("--preset", choices=("full", "smoke"), default="full")
    p.add_argument("--out-root", default="v0.6.0_global_orbit_output")
    p.add_argument("--archive", default="SST_fermat_pybind_research_v0.6.0_global_orbit_results.zip")
    ...
    manifest = {
        "schema": "sst.fermat.global-orbit-campaign-manifest.v0.6.0",
