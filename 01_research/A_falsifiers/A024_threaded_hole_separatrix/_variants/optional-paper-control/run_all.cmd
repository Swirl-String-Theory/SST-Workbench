...
python "%PU_WB%\07_scripts\paper_upgrade_runtime.py" stage --family "%PU_FAMILY%" --tier "%PU_TIER%" --out "%PU_OUT%" --id "_dp0run_all_kelvin_hole_basic_cmd" %PU_RESUME_FLAG% -- "%~dp0run_all_kelvin_hole_basic.cmd" || exit /b 1
