---
name: RESTRUCTURE PLAN v0.1
todos:
  - id: t00
    content: "All 73 roots mapped (human-readable tables)"
    status: completed
  - id: t01
    content: "`path_map.csv` seeded / updated to match CATALOG (machine artifact wins)"
    status: completed
  - id: t02
    content: "01_research / 02_libraries / 03_data destinations frozen to inventory tables"
    status: completed
  - id: t03
    content: "Soft-delete rule: former deletes → `DELETE/<original/relative/path>`"
    status: completed
  - id: t04
    content: "JSON restructure map regenerated from CATALOG + path_map"
    status: completed
  - id: t05
...
- [x] All 73 roots mapped (human-readable tables)
- [x] `path_map.csv` seeded / updated to match CATALOG (machine artifact wins)
...
|---|--------------|-------------|------|-------|
| 1 | `Fremlin_FourierSeries/` | `D/A/02_fourier/fremlin_fourier_series/` | data | SP04 |
| 2 | `generated-figures/` | `D/D/figures/` | output | SP04 |
| 3 | `Ideal_Sources/` | `D/A/01_ideal/ideal_sources/` | data | SP04 |
...
| 18 | `verification-suites/` | `R/D/D003_verification_suites/` | code | SP05 |
...
|---|--------------|-------------|---------:|-------|
| 19 | `SST_6Source_Blind_Falsifier_v0.1.0/` | `R/A/A020_six_source_blind_energy/` | 1 | SP05 |
| 20 | `SST_7Article_Closure_Holonomy/` | `R/A/A028_seven_article_closure_holonomy/` | 3 | SP05 |
| 21 | `SST_Breathing_Stretching_Return_Phase_Causality/` | `R/A/A033_breathing_stretching_return_phase/` | 1 | SP05 |
| 22 | `SST_Chiral-Kelvin-Mode/` | `R/A/A008_chiral_kelvin_core/` | 5 | SP05 |
| 23 | `SST_Chirality_Helicity_Transport_Polarity/` | `R/A/A037_chirality_helicity_transport_polarity/` | 2 | SP05 |
| 24 | `SST_Coil_DigitalTwin_research/` | `R/F/F001_coil_digital_twin/` | 7 | SP05 |
| 25 | `SST_CoilLab_research/` | `R/F/F003_coil_lab/` | 2 | SP05 |
| 26 | `SST_contact_billiard_hydrodynamic_falsifier/` | `R/A/A006_contact_billiard_hydrodynamic/` | 2 | SP05 |
| 27 | `SST_contra_swirl_bridge_research/` | `R/B/B005_contra_swirl_bridge/` | 5 | SP05 |
| 28 | `SST_counterpulley_alpha_falsifier/` | `R/A/A010_counterpulley_alpha_ropelength/` | 2 | SP05 |
| 29 | `SST_dark_knot_rayleigh_research/` | `R/A/A003_dark_knot_rayleigh/` | 1 | SP05 |
| 30 | `SST_derive_constants_research/` | `R/B/B001_derive_constants/` | unversioned | SP05 |
| 31 | `SST_dimensionless_dynamic_predictions/` | `R/A/A004_dimensionless_dynamic_predictions/` | 4 | SP05 |
| 32 | `SST_fermat_pybind_research/` | `R/C/C007_fermat_biot_savart/` | 12 | SP05 |
| 33 | `SST_Finite_Core_Axial_Toroidal_Phase_Delay/` | `R/A/A029_finite_core_axial_toroidal_phase_delay/` | 3 | SP05 |
| 34 | `SST_Fourier_vs_Ideal_Blind_Falsifier/` | `R/A/A022_fourier_vs_ideal/` | 2 | SP05 |
| 35 | `SST_fs_attachment_audit_research/` | `R/F/F001_fs_attachment_audit/` | unversioned | SP05 |
| 36 | `SST_Helmholtz/` | `R/A/A016_helmholtz_vortex_transport/` | 2 | SP05 |
| 37 | `SST_ideal_links/` | `R/A/A007_ideal_links_topology_robustness/` | 14 | SP05 |
| 38 | `SST_Katlas_Link_Geometry_Conditioning_v2.0.0/` | `R/E/E003_katlas_link_geometry_conditioning/v2.0.0/` | 1 | SP05 |
| 39 | `SST_Material_Phase_EFT/` | `R/A/A030_material_phase_eft_holonomy/` | 2 | SP05 |
| 40 | `SST_minimal_falsification_harness/` | `R/D/D006_minimal_falsification_harness/` | 3 | SP05 |
| 41 | `SST_Phase_Feedback_Delay_Knot_Stability/` | `R/A/A026_phase_feedback_delay_knot_stability/` | 4 | SP05 |
| 42 | `SST_preferred_frame_binary_falsifier/` | `R/A/A009_preferred_frame_binary/` | 2 | SP05 |
| 43 | `SST_Quantum_Galileo_Action_Gauge_Closure/` | `R/A/A042_quantum_galileo_action_gauge_closure/` | 2 + key | SP05 |
| 44 | `SST_ssdl_audit_research/` | `R/B/B007_ssdl_audit/` | 2 | SP05 |
| 45 | `SST_Sutcliffe_HSS_feasibility_gate/` | `R/D/D007_sutcliffe_hss_feasibility_gate/` | 1 | SP05 |
| 46 | `SST_Trefoil_Dynamic_Seed_Qualification_Mega_Falsifier/` | `R/A/A038_trefoil_dynamic_seed_qualification/` | 7 + 1 odd | SP05 |
| 47 | `SST_vArrow_Spectral_Blind_Falsifier/` | `R/A/A027_spectral_swirl_clock/` | 3 | SP05 |
...
| 50 | `Wien_Planck_SST_Field_Matter_Closure/` | `R/A/A041_wien_planck_field_matter_closure/` | 6 | SP05 |
| 51 | `SST_routeB_RT_bem_research/` | `R/B/B004_route_b_rt_bem/` | 22 + shared | SP05 |
...
|---|--------------|-------------|------:|-------|
| 52 | `SST_Maxwell/` | `R/A/{A011,A012,A013,A014,A015}` | 6 | SP06 |
| 53 | `SST_Intrinsic_Modal_Swirl_Clock/` | `R/A/{A035,A036,A039,A040}` | 4 | SP06 |
| 54 | `SST_Threaded_Hole_Substrate_Blind_Falsifier_v0.1.0/` | `R/A/{A024,A025}` | 2 | SP06 |
| 55 | `SST_Trefoil_Lobe_Orientation_Blind_Falsifier/` | `R/A/{A021,A023,A031}` | 3 | SP06 |
| 56 | `SST_Einstein/` | `R/A/{A017,A018}` | 2 | SP06 |
| 57 | `SST_Kelvin_Floquet/` | `R/A/{A019,A032}`, `R/C/C008` | 3 | SP06 |
...
|---|--------------|-------------|-------|
| 70 | `to_be_processed/` | `git mv` → `DELETE/to_be_processed/` (preserve relative path) | SP11 |
| 71 | `experiments/` | `experiments/sycl/` to `R/F/F008_sycl_probes/`; `derive_constants/` and `trefoil/` stubs → `DELETE/experiments/...` | SP06 / SP11 |
| 72 | `falsifier_registry/` | `README.md` to `10_docs/registry/`; README `git mv` → `DELETE/falsifier_registry/`; `falsifier_registry.yaml` stays at repo root | SP04 / SP11 |
...
| Root `knots_ideal_favorites.txt`, `rhof_triage.csv` | `D/A/01_ideal/ideal_sources/` | SP04 |
