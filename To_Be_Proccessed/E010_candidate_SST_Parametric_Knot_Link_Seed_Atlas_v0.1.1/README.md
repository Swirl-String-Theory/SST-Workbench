# SST Parametric Knot–Link Seed Atlas (PKLSA) v0.1.1
...
## v0.1.1 portability note

This release changes packaging only. Python bytecode caches are excluded from signed manifests; the 2352 candidate geometries and candidate IDs are unchanged from v0.1.0.
