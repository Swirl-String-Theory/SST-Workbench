...
def run_panel(entries,cfg_path,out_dir,*,backend='auto',allow_sycl_cpu=False,force_build=False,build_verbose=False,resume=True):
    ...
    mod=load_native(force_build=force_build,build_verbose=build_verbose);binfo=native_info(mod, probe_sycl_worker=(backend=='sycl'));write_json(out/'backend_info.json',binfo)
