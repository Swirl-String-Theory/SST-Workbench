...
def scan_stationary_candidates(
    ...
    *,
    ...
    return {
        "schema": "sst.fermat.candidate-atlas.v0.6.1",
...
def certify_candidate_convergence(
    ...
    *,
    ...
    return {
        "schema": "sst.fermat.convergence-report.v0.6.1",
        "package_version": PACKAGE_VERSION,
...
def build_bifurcation_atlas(
    ...
    *,
    ...
    return {
        "schema": "sst.fermat.bifurcation-atlas.v0.6.1",
        "package_version": PACKAGE_VERSION,
...
def symmetry_field_audit(
    ...
    *,
    ...
    return {
        "schema": "sst.fermat.symmetry-audit.v0.6.1",
        "package_version": PACKAGE_VERSION,
        "knot_id": knot_id,
        "epsilon_over_rc": epsilon,
        "backend": backend,
