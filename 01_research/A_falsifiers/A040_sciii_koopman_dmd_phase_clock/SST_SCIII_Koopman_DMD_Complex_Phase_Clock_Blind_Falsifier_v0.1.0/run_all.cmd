...
setlocal
echo ============================================================
echo SST SC-III Koopman/DMD Complex Phase-Clock Blind Falsifier v0.1.0
echo Full-shape recurrence is NOT required.
echo Primary observable: predictive complex phase under local Koopman/DMD moving-subspace continuation.
echo.
echo Examples:
