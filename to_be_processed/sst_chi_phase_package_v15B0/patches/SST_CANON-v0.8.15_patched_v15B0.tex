...
%! DOI = 10.5281/zenodo.21164143
%! v0.8.15 edition: Lorentz-type swirl-stress / EM correspondence (been_processed).
...
\newcommand{\paperdoi}{10.5281/zenodo.21164143}
\newcommand{\papertitle}{Swirl-String-Theory Canon-v0.8.15}
...
\section{Formal Foundations}
    ...
    % ============================================================
    % CANON LEMMA v15B.0: single-modulus resolved core envelope
    % ============================================================
    \subsection{Canonical Single-Modulus Core-Envelope Lemma}
    \label{subsec:canon_single_modulus_core_envelope}

    \paragraph{Status.}
    \textbf{[CANON LEMMA / LOCAL CORE MODEL].}  The resolved internal SST core
    ...
    \end{equation}
    The single-modulus statement is the equality of the radial-amplitude and
    ...
    This lemma canonizes the local one-modulus internal core-envelope reduction and
    its consequence \(A=B=C\).  It does not canonize an exact identification of
...
\section{Delay and Mode Selection Theory}
    ...
    \subsection{Circulation Delay as a Physical Primitive}
        ...
        \begin{align}
            \tau_c = \frac{2\pi \rc}{\vchar} = \frac{2\pi}{\omega_c}
...
\section{Unified Interpretation}
    ...
    \subsection{Notation and density cleanup}
        ...
        \begin{align}
            ...
            \rhoM = \rhoE/c^2,
            \qquad
            \rhohorn \quad \text{(canonical saturated envelope-equivalent density)},
            \qquad
            \rhocore \quad \text{(legacy alias, deprecated unless explicitly defined)}.
        \end{align}
...
\section*{Appendices}
    ...
    \section{Conversation-Derived Insights}
        ...
        \subsection{Canon edition notes (v0.8.15)}
        ...
        \subsection{Canon edition notes (v0.8.14)}
        ...
        \subsection{Canon edition notes (v0.8.13)}
        ...
        \subsection{Canon edition notes (v0.8.12)}
        ...
        \subsection{Canon edition notes (v0.8.11)}
        ...
        \subsection{Canon edition notes (v0.8.10)}
        ...
        \subsection{Canon edition notes (v0.8.9)}
        ...
        \subsection{Canon edition notes (v0.8.8)}
        ...
        \subsection{Canon edition notes (v0.8.7)}
        ...
        \subsection{Canon edition notes (v0.8.6)}
        ...
        \subsection{Canon edition notes (v0.8.5)}
        ...
        \subsection{Canon edition notes (v0.8.4)}
        ...
        \subsection{Canon edition notes (v0.8.3)}
        ...
        \subsection{Canon edition notes (v0.8.2)}
...
% ---------------------------
        \newpage
        \input{SST_CANON-v0.8.15-research-track}
