...
def main(argv=None):
    ...
    a=s.add_parser('analyze-sciii-stage-a');a.add_argument('work');a.add_argument('config')
    a=s.add_parser('analyze-sciii-gauge');a.add_argument('work');a.add_argument('config')
    a=s.add_parser('analyze-sciii-provenance');a.add_argument('work');a.add_argument('config')
    a=s.add_parser('analyze-sciii-stage-b');a.add_argument('work');a.add_argument('config')
    ...
    elif ns.cmd=='analyze-sciii-stage-a':o=run_analyze_sciii_stage_a(ns.work,ns.config)
    elif ns.cmd=='analyze-sciii-gauge':o=run_analyze_sciii_gauge(ns.work,ns.config)
    elif ns.cmd=='analyze-sciii-provenance':o=run_analyze_sciii_provenance(ns.work,ns.config)
    elif ns.cmd=='analyze-sciii-stage-b':o=run_analyze_sciii_stage_b(ns.work,ns.config)
