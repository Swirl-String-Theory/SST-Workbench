...
python -m sst_modal_clock.cli analyze-sc2-stage-a "%OUT%" config\extended.json || exit /b 1
...
python -m sst_modal_clock.cli analyze-sc2-stage-a-gauge "%OUT%" config\extended.json || exit /b 1
echo [7/10] Seed-provenance robustness
python -m sst_modal_clock.cli analyze-sc2-provenance "%OUT%" config\extended.json || exit /b 1
...
python -m sst_modal_clock.cli analyze-sc2-stage-b "%OUT%" config\extended.json || exit /b 1
