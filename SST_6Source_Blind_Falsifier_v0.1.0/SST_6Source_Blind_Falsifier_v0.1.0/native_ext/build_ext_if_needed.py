...
def build_if_needed(force: bool = False, verbose: bool = True) -> bool:
    ...
    meta = {"hash": src_hash, "compiler": compiler or "setuptools/MSVC", "ext": out.name, "cpp": str(CPP_REL)}
    ...
    # On Windows a c++ executable is often absent even though MSVC is available.
    # Always give setuptools/build_ext a chance to discover MSVC.
    if not ok:
