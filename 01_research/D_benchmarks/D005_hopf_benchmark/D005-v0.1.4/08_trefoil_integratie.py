...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--spin-evidence", type=Path, action="append", default=[], help="H6-H9 evidence JSON; may be supplied multiple times")
...
def main() -> int:
    ...
    spin_payloads = [read_json(path) for path in args.spin_evidence]
    spin_ev = {"sources": spin_payloads}
    ...
    upstream_available = {
        ...
        "H3": h3 is not None,
        "H5": h5 is not None,
        **{g: upstream[g] is not None for g in upstream},
    }
    ...
    h10 = gate_record(
        ...
        notes=[
            ...
            "Upstream availability is reported separately from upstream closure.",
        ],
