...
python -m sst_modal_clock.cli analyze-sciii-stage-a "%OUT%" config\extended.json || exit /b 1
...
python -m sst_modal_clock.cli analyze-sciii-gauge "%OUT%" config\extended.json || exit /b 1
echo [7/10] Seed-provenance robustness
python -m sst_modal_clock.cli analyze-sciii-provenance "%OUT%" config\extended.json || exit /b 1
...
python -m sst_modal_clock.cli analyze-sciii-stage-b "%OUT%" config\extended.json || exit /b 1
