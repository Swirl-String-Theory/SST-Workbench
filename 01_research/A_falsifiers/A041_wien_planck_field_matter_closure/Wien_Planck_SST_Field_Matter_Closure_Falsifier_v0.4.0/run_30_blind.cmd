...
"%PY%" -m sst_wp.report "%OUT%\BLIND_RESULTS.json" --out "%OUT%\REPORT_BLIND.md" --title "Wien-Planck SST v0.4.0 PKLSA-2352 GPU-FUNNEL STRICT DIMENSIONLESS BLIND report" || exit /b 1
"%PY%" -m sst_wp.archive_outputs "%OUTROOT%" --mode blind --dest "..\Wien_Planck_SST_Field_Matter_Closure_Falsifier_v0.4.0-outputs_BLIND.zip" || exit /b 1
"%PY%" -m sst_wp.archive_outputs "%OUTROOT%" --mode blind --dest "..\Wien_Planck_SST_Field_Matter_Closure_Falsifier_v0.4.0-outputs.zip" || exit /b 1
