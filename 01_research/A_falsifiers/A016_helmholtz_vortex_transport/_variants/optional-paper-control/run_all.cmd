...
python "%PU_WB%\07_scripts\paper_upgrade_runtime.py" stage --family "%PU_FAMILY%" --tier "%PU_TIER%" --out "%PU_OUT%" --id "all_normal" %PU_RESUME_FLAG% -- run_all_normal.cmd || exit /b 1
