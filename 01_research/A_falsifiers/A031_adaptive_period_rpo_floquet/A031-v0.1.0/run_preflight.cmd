...
"%SST_V048_DIR%\.venv\Scripts\python.exe" rpo_falsifier.py --config configs\basic.json --out-dir outputs\preflight --target "%SST_V048_DIR%" --atlas "%SST_ATLAS_ROOT%" --preflight-only
exit /b %ERRORLEVEL%
