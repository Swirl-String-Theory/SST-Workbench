# SST Ideal Links Comprehensive Test Suite v0.2.0

This release upgrades the v0.1.0 NumPy prototype to the C++17/pybind11 audit architecture used by the supplied `SST_cpp_pybind_audit_template`.
