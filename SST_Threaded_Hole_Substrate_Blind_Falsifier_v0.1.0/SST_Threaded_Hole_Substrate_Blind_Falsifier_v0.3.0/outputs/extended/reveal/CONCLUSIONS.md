...
## Self-confinement
- Carrier-clustered verdict: **INDETERMINATE** — active carriers 0, null carriers 3.

## Pressure / gravity
- Central pressure: **SUPPORTS_THREAD_DENSITY_PRESSURE_DEFICIT**.
- Even quadratic pressure law: **SUPPORTS_NEGATIVE_EVEN_QUADRATIC_THREAD_PRESSURE**.
- Source monopole: **INDETERMINATE_OR_WRONG_MONOPOLE**.
- Free exponent: **INDETERMINATE_FREE_EXPONENT**, median ν=0.36875.
- Exponent convergence: **NEEDS_OR_FAILS_FAR_FIELD_CONVERGENCE**; monopole convergence: **NEEDS_OR_FAILS_MONOPOLE_CONVERGENCE**.
- Combined: **PRESSURE_DEFICIT_SUPPORTED_GRAVITY_CLOSURE_NOT_CLOSED**.
...
## Stability discovery
- 8 carrier minima reported as discovery only.
