...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--integer-tolerance", type=float, default=0.05)
...
def main() -> int:
    ...
    if h1_pass:
        gates[1]["qualification"] = "CERTIFIED_PASS" if final["delta_integer"] <= 0.01 else "STANDARD_PASS"
    else:
        gates[1]["qualification"] = "FAIL"
    for gate in gates:
        gate["runtime"] = runtime_provenance()
    ...
    json_dump(args.output / "H0_H3_evidence.json", {"runtime": runtime_provenance(), "gates": gates})
