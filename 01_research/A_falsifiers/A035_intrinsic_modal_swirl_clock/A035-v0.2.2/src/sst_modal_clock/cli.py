...
from .workflow import run_prepare,run_prepare_provenance,run_scan_provenance,run_branch,run_analyze_stage_a,run_analyze_stage_a_gauge,run_analyze_provenance,run_analyze_stage_b,reveal
...
def main(argv=None):
    ...
    a=s.add_parser('prepare-provenance');a.add_argument('work');a.add_argument('config')
    a=s.add_parser('scan-provenance');a.add_argument('config')
    ...
    elif ns.cmd=='prepare-provenance':o=run_prepare_provenance(ns.work,ns.config)
    elif ns.cmd=='scan-provenance':o=run_scan_provenance(ns.config)
